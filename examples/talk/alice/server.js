...
// spawn alice-llm.py
console.log("spawn alice-llm.py");
spawn_llm("alice-llm.py", "127.0.0.1", "10000", "");
...
watchFile(WATCH_FILE, (eventType, filename) => {
  if (eventType === "change") {
    console.log(`File ${eventType}: ${filename}`);

    // Broadcast MP3 URL to all connected clients
    const mp3Url = `http://localhost:${MAIN_PORT}/audio.mp3`;
